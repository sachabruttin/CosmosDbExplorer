...
namespace CosmosDbExplorer.Services
{
    public interface IDocumentDbService
    {
        ...
        Task<ImportDocumentResponse> ImportDocumentAsync(Connection connection, DocumentCollection collection, string content, bool allowUpsert, bool allowIdGeneration, int? maxConcurrencyPerPartitionKeyRange, int? maxInMemorySortingBatchSize, CancellationToken cancellationToken);
